...
\begin{itemize}
\item Attendance in random: 20\%
\item Paper: 40\%
\item Presentation: 40\%.
\end{itemize}
\end{frame}
...
6 & Chapter 05.\\
\hline
7 & \textcolor{Green}{Paper preparation}.\\
\hline
8 & \textcolor{Green}{Paper preparation}.\\
\hline
\end{tabular}
\end{center}
\end{frame}
...
\item If any suspicious behavior recoreded, must loss the right to chose this course again. \\
\end{enumerate}
\end{frame}
\begin{frame}{}
\begin{center}
