...
\usepackage{handout}
\title{PS4010: Political Ideology}
\author{Tom T. Hsiao}
\date{\today}
\begin{document}
...
\item We will announced a problem of final examination in the last week of the course.
\end{itemize}
\end{frame}
...
Week & Topic & Remark \\
\hline
1 & Lesson 0 & Preliminaries\\
\hline
2 - 3 & Lesson 1 & Chap. 2 to 3 \\
\hline
4 - 8 & Lesson 2 & Chap. 3 to 7 \\
\hline
9 - 14 & Lesson 3 & Chap. 8 to 12 and 14 \\
\hline
15 & \textcolor{red}{Examination} & \\
\hline
16 & Summary &  \\
\hline
\end{tabular}
